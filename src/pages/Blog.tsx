...
function PageHero() {
  return (
    <section
      ...
      style={{
        backgroundImage: 'linear-gradient(135deg, rgba(29, 53, 87, 0.85) 0%, rgba(69, 123, 157, 0.85) 100%), url("/images/hero_blog.jpg")',
        minHeight: '40vh',
      }}
    >
...
const blogPosts = [
  {
    ...
    date: 'June 1, 2026',
    content: (
      <div className="space-y-6 text-base md:text-[17px] text-[#4E6178] leading-relaxed">
        <p>
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">1. Who You Are & What You Do</h4>
        <p>
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">2. Your Level of Professionalism</h4>
        <p>
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">3. Your Core Values & Brand Personality</h4>
        <p>
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">4. Memorable Distinction</h4>
        <p>
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">5. Adaptability Across Mediums</h4>
        <p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-6 text-base md:text-[17px] text-[#4E6178] leading-relaxed">
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">1. Physical Tangibility & Trust</h4>
        <p>
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">2. Tactile First Impressions</h4>
        <p>
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">3. Flawless Visual Accuracy</h4>
        <p>
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">4. Higher Engagement Rates</h4>
        <p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-6 text-base md:text-[17px] text-[#4E6178] leading-relaxed">
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">What is Branding?</h4>
        <p>
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">What is Marketing?</h4>
        <p>
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">The Interplay: Brand First, Then Market</h4>
        <p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-6 text-base md:text-[17px] text-[#4E6178] leading-relaxed">
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">1. The Bold Headline Hook</h4>
        <p>
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">2. Clear Visual Hierarchy</h4>
        <p>
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">3. An Irresistible Call-to-Action (CTA)</h4>
        <p>
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">4. Quality Paper and Finish</h4>
        <p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-6 text-base md:text-[17px] text-[#4E6178] leading-relaxed">
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">1. Create Unified Visual Standards</h4>
        <p>
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">2. Standardize Your Brand Voice</h4>
        <p>
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">3. Establish a Brand Style Guide</h4>
        <p>
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">4. Perform Regular Brand Audits</h4>
        <p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-6 text-base md:text-[17px] text-[#4E6178] leading-relaxed">
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">1. Contrast and Legibility</h4>
        <p>
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">2. Proper Scale and Placement</h4>
        <p>
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">3. Simplified Message Delivery</h4>
        <p>
        ...
        <h4 className="text-xl font-bold text-[#1D3557] mt-8 mb-3">4. Durable Materials and Lighting</h4>
        <p>
...
const categoryColors: Record<string, string> = {
  ...
  Strategy: 'bg-[#1D3557] text-white',
  Design: 'bg-[#457B9D] text-white',
      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
        ...
        >
          {blogPosts.map((post, i) => (
            <article
              key={post.title}
              className="group rounded-2xl overflow-hidden border border-[#D0E1E6] hover:shadow-lg transition-all duration-300 flex flex-col h-full"
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow">
                <div className="flex items-center gap-3 mb-3">
                  <span className={`${categoryColors[post.category] || 'bg-[#457B9D] text-white'} text-white text-xs font-medium px-2.5 py-1 rounded-full`}>
                    {post.category}
                  </span>
                  <span className="text-xs text-[#4E6178] flex items-center gap-1">
                    <Clock size={12} /> {post.readTime}
                  </span>
                </div>
                <h3 
                  className="font-semibold text-[#1D3557] mb-2 group-hover:text-[#457B9D] transition-colors duration-200 leading-snug cursor-pointer flex-grow"
                  onClick={() => setSelectedPost(post)}
                >
                  {post.title}
                </h3>
                ...
                <div className="flex items-center justify-between mt-auto pt-4 border-t border-[#D0E1E6]">
                  <span className="text-xs text-[#4E6178]">{post.date}</span>
                  <span 
                    onClick={() => setSelectedPost(post)}
                    className="text-sm font-medium text-[#457B9D] flex items-center gap-1 group-hover:gap-2 transition-all duration-200 cursor-pointer select-none"
                  >
          ...
          >
            ...
            <div className="h-48 sm:h-64 md:h-full md:col-span-5 relative shrink-0">
              ...
              <div className="absolute top-4 left-4">
                <span className={`${categoryColors[selectedPost.category] || 'bg-[#457B9D] text-white'} text-xs font-semibold tracking-wider uppercase px-3.5 py-1.5 rounded-full shadow-md`}>
            ...
            <div className="flex-grow flex-shrink md:col-span-7 flex flex-col relative min-h-0 h-full">
              ...
              <DialogClose className="absolute top-5 right-5 z-50 p-2 bg-white hover:bg-[#F0F7F9] text-[#4E6178] hover:text-[#1D3557] rounded-full border border-[#D0E1E6] shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-[#457B9D]">
                <X size={16} />
              </DialogClose>
              ...
              <div className="flex-grow overflow-y-auto p-8 sm:p-10 md:p-12 lg:p-14">
                ...
                <span className="text-[11px] font-extrabold tracking-widest text-[#457B9D] uppercase mb-2 self-start block">
                  {selectedPost.category} Article
                </span>
                
                {/* Title */}
                <DialogTitle className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#1D3557] leading-tight font-sans tracking-tight mb-4 pr-10">
                  {selectedPost.title}
                </DialogTitle>

                {/* Date & Reading time */}
                <div className="flex items-center gap-4 text-xs sm:text-sm text-[#4E6178] font-medium mb-6">
                ...
                {/* Separator line */}
                <hr className="border-[#D0E1E6] mb-8" />
                
                {/* Body content */}
                <div className="mt-2 text-[#4E6178] leading-relaxed">
